...
public class SupplierServiceImpl implements SupplierService {
    ...
    @Override
    public void seedSuppliers(SupplierSeedRootDto supplierDtos) {
        for (SupplierDto supplierDto : supplierDtos.getSupplierDtos()) {
    ...
    @Override
    public SupplierInfoRootDto getLocalSuppliers() {
        SupplierInfoRootDto supplierInfoRootDto = new SupplierInfoRootDto();
        supplierInfoRootDto.setSupplierInfoDtos(this.supplierRepository.getAllByIsImporterIsFalse()
                .stream()
                .map(s->{
