...
public class ExportController extends BaseController {
    ...
    public ModelAndView exportProjectsWithNameEnding(ModelAndView projectModelAndView) throws IOException {
        String projectsWithNameEnding = this.projectService.exportProjectsWithNameEnding();

        projectModelAndView.addObject("projectsWithNameEnding", projectsWithNameEnding);
        return super.view("export/export-projects-with-name-ending", projectModelAndView);
    }
